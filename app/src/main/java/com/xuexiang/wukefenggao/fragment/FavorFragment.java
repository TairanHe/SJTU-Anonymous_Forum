...
//                    holder.text(R.id.tv_tag, model.getTag());
                    ...
                    holder.text(R.id.tv_tag, model.getWhetherReadUpdate() == 0 ? "有新的更新" : "已读"); // 这里设置已读未读
                    if(model.getWhetherReadUpdate() == 0)
                    {
...
//                refreshLayout.finishRefresh();
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            msg.arg1 = 0;
                            msg.obj  =ExchangeInfosWithAli.GetFavourThread_json();
                            if (msg.obj == null){
                                msg.arg1 = -1;
                            }
                        } catch (JSONException | IOException e) {
