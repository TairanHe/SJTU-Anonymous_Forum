...
public class AnonymousName {
    ...
    public static String getname(String sequence, String type){
        if(type.equals("abc")){
            System.out.println(ABC_English_Name_List.get(Integer.parseInt(sequence)));
            return ABC_English_Name_List.get(Integer.parseInt(sequence));
        }
        else if (type.equals("us_president")){

            System.out.println(US_President_English_Name_List.get(Integer.parseInt(sequence)));
            return US_President_English_Name_List.get(Integer.parseInt(sequence));
        }
        else
